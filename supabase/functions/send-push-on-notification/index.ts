...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    "workOrder.created.body": "{workOrderName} - Vencimento: {dueDate}",
    ...
    "event.reminder24h.title": "Lembrete de Evento",
    "event.reminder24h.body": "{reminderLabel}",
    "workOrder.reminder24h.title": "Lembrete de Ordem de Serviço",
    "workOrder.reminder24h.body": "{reminderLabel}",
  ...
  en: {
    ...
    "workOrder.created.body": "{workOrderName} - Due date: {dueDate}",
    ...
    "event.reminder24h.title": "Event Reminder",
    "event.reminder24h.body": "{reminderLabel}",
    "workOrder.reminder24h.title": "Work Order Reminder",
    "workOrder.reminder24h.body": "{reminderLabel}",
  ...
  de: {
    ...
    "workOrder.created.body": "{workOrderName} - Fällig am: {dueDate}",
    ...
    "event.reminder24h.title": "Ereignis-Erinnerung",
    "event.reminder24h.body": "{reminderLabel}",
    "workOrder.reminder24h.title": "Serviceauftrag-Erinnerung",
    "workOrder.reminder24h.body": "{reminderLabel}",
  ...
  fr: {
    ...
    "workOrder.created.body": "{workOrderName} - Échéance : {dueDate}",
    ...
    "event.reminder24h.title": "Rappel d'Événement",
    "event.reminder24h.body": "{reminderLabel}",
    "workOrder.reminder24h.title": "Rappel de Commande de Service",
    "workOrder.reminder24h.body": "{reminderLabel}",
  ...
  it: {
    ...
    "workOrder.created.body": "{workOrderName} - Scadenza: {dueDate}",
    ...
    "event.reminder24h.title": "Promemoria Evento",
    "event.reminder24h.body": "{reminderLabel}",
    "workOrder.reminder24h.title": "Promemoria Ordine di Servizio",
    "workOrder.reminder24h.body": "{reminderLabel}",
  ...
  es: {
    ...
    "workOrder.created.body": "{workOrderName} - Vence: {dueDate}",
    ...
    "event.reminder24h.title": "Recordatorio de Evento",
    "event.reminder24h.body": "{reminderLabel}",
    "workOrder.reminder24h.title": "Recordatorio de Orden de Servicio",
    "workOrder.reminder24h.body": "{reminderLabel}",
...
function generateTitleAndBody(
  ...
  const vars: Record<string, unknown> = {
    ...
    workOrderName: payload.workOrderName || payload.clientName || (lang === "pt" ? "Work Order" : "Work Order"),
